        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "new_flight": {
                        "type": "string",
                        "description": "Flight code for the new flight.",
                    },
                },
                "required": ["booking_reference"],
                "additionalProperties": False,
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "flight_details": {
                        "type": "string",
                        "description": "Details of the flight to book.",
                    }
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "interline_flight": {
                        "type": "string",
                        "description": "Details of the interline partner flight.",
                    }
                },
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "original_payment_method": {
                        "type": "string",
                        "description": "Original payment method used.",
                    },
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "bonus_percentage": {
                        "type": "number",
                        "description": "Bonus percentage to apply to the travel credit.",
                    },
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "medical_certificate": {
                        "type": "string",
                        "description": "Medical certificate provided by the customer.",
                    },
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "documentation": {
                        "type": "string",
                        "description": "Relevant documentation provided by the customer.",
                    },
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "bereavement_documentation": {
                        "type": "string",
                        "description": "Bereavement documentation provided by the customer.",
                    },
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "booking_reference": {
                        "type": "string",
                        "description": "Booking reference of the unaccompanied minor.",
                    }
                },
                "required": ["booking_reference"],
                "additionalProperties": False,
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "new_destination": {
                        "type": "string",
                        "description": "New destination requested by the customer.",
                    },
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "booking_reference": {
                        "type": "string",
                        "description": "Third-party booking reference.",
                    }
                },
                "required": ["booking_reference"],
                "additionalProperties": False,
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "resolution_details": {
                        "type": "string",
                        "description": "Details of how the case was resolved.",
                    },
                },
